...
| :--- | :--- | :--- | :--- |
| **Project J.A.R.V.I.S. (AgentOS)** | Production-grade autonomous AgentOS uniting physical microcontrollers, native Windows computer-use (UIA + Vision), mobile Telegram 2.0 ReAct control, local ONNX neural wake-word, and AWS cloud mesh with differential rollback and chained audit ledger. | Python, FastAPI, WebSockets, Win32 UIAutomation, ONNX openWakeWord, Telegram, AWS Boto3, Groq LPU | [Read Notes](./projects/project-jarvis.md) • [GitHub](https://github.com/ShyamD2/project-jarvis) |
